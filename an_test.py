...
def main():
    ...
    & ak.all(abs(arr.particles[:, [-2, -1]].vector.eta) < 4.7, axis=1) 
        ...
        rootfile['tree'] = {
            ...
            'ptl2': ak.fill_none(ptl1[cuts], 0),
            'phil2': ak.fill_none(ptl1[cuts], 0),
            'etal1': ak.fill_none(ptl1[cuts], 0),

            'mJJ': ak.fill_none(mJJ[cuts], 0),
            'deltaPhiJJ': ak.fill_none(deltaPhill[cuts], 0),
            'deltaEtaJJ': ak.fill_none(deltaEtall[cuts], 0),
            'ptJ1': ak.fill_none(ptl1[cuts], 0),
            'phiJ1': ak.fill_none(phil1[cuts], 0),
            'etaJ2': ak.fill_none(etal1[cuts], 0),
            'ptJ2': ak.fill_none(ptl1[cuts], 0),
            'phiJ2': ak.fill_none(ptl1[cuts], 0),
            'etaJ1': ak.fill_none(ptl1[cuts], 0),
