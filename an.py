...
def main():
    ...
    & ak.all(abs(arr.particles[:, [-2, -1]].vector.eta) < 4.7, axis=1) 
        ...
        rootfile['tree'] = {
            'mll': ak.fill_none(mll[cuts], -1),
            'deltaPhill': ak.fill_none(deltaPhill[cuts], 100),
            'deltaEtall': ak.fill_none(deltaEtall[cuts], 100),
            'ptl1': ak.fill_none(ptl1[cuts], -1),
            'phil1': ak.fill_none(phil1[cuts], -1),
            'etal1': ak.fill_none(etal1[cuts], -1),
            'ptl2': ak.fill_none(ptl2[cuts], -1),
            'phil2': ak.fill_none(phil2[cuts], -1),
            'etal1': ak.fill_none(etal2[cuts], -1),

            'mJJ': ak.fill_none(mJJ[cuts], -1),
            'deltaPhiJJ': ak.fill_none(deltaPhiJJ[cuts], 100),
            'deltaEtaJJ': ak.fill_none(deltaEtaJJ[cuts], 100),
            'ptJ1': ak.fill_none(ptJ1[cuts], -1),
            'phiJ1': ak.fill_none(phiJ1[cuts], -1),
            'etaJ2': ak.fill_none(etaJ1[cuts], -1),
            'ptJ2': ak.fill_none(ptJ2[cuts], -1),
            'phiJ2': ak.fill_none(phiJ2[cuts], -1),
            'etaJ1': ak.fill_none(etaJ2[cuts], -1), 
