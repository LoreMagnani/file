#stampa dei plot in stile cms a partire da file root contenenti istogrammi chiamati histo_<nome variabile>.root
#per ogni file stampa un plot per ognuni dei seguenti 8 operatori (se si vogliono studiare operatori diversi vanno cambiati nel codice)
#operatori = [cWtil , cHWtil , cHBtil , cHGtil , cHWBtil , cbBIm , cbWtil , clebQIm]
import uproot
...
#cerco i file e ciclo su ogni file trovato
...
for nome_file in os.listdir(output_path):
    if nome_file.endswith(".root") and nome_file.startswith("hist_"):
        ...
        for ope in opes:
            ...
            #groupPlot sono dizionari che serviranno per il plot (ontengono informazioni su nome, colore e sample)
            groupPlot = {}
            ...
            #vengono letti gli istogrammi e usati per definire le caratteristiche di sample
            samples = {}
            bins = -1
            c_data = 0
